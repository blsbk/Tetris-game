...
// bgm.setAttribute('scr', './assets/bgm.mp3');
// bgm.muted = true;

// breakSound.setAttribute('scr', './assets/break.mp3');
// breakSound.muted = true;

// drop.setAttribute('scr', './assets/drop.mp3');
// drop.muted = true;
...
function moveTetromino(direction){
    ...
    if (!canTetrominoMove(1,0) && currentTetromino.row === 0) {
        lives--;
...
function endGame() {
    ...
    let restart = document.getElementById("startOverButton");
    let totalScore = document.getElementById("scoreElement");
    let over = document.createElement('img');
    over.setAttribute('src', './assets/over.png');
    while (scoreSection.firstChild) {
        scoreSection.removeChild(scoreSection.firstChild);
    }
    scoreSection.appendChild(over);
    scoreSection.appendChild(totalScore);
    scoreSection.appendChild(restart);
...
// Get a reference to the "Start Over" button
const startOverButton = document.getElementById("startOverButton");

// Add a click event listener to the button
startOverButton.addEventListener("click", gameReset);
 function gameReset() {
 ...
 function pauseGame() {
    if (!paused) {
        document.getElementById("pauseButton").src = "./assets/play.png"
        paused = true;
    } else {
        document.getElementById("pauseButton").src = "./assets/pause.png"
        paused = false;
    }
